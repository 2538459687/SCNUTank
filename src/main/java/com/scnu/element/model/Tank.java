...
import com.scnu.game.Attributes;
import com.scnu.game.GetInfo;

import java.awt.*;
import java.util.Vector;

import static com.scnu.element.model.Bullet.enemyTankBullet;
import static com.scnu.element.model.Bullet.myTankBullet;
import static com.scnu.element.model.CollisionDetection.isAboutTouchForTank;
import static com.scnu.game.Attributes.BULLET_SIZE;
...
public class Tank implements GetInfo {
    ...
    public void moveRight() {
        for (int i = 0; i < speed; i++) {
            ...
            if (x + OBJECT_SIZE < Attributes.WINDOW_WIDTH && getDirectionLock() != Direction.RIGHT) {
                x += 1;
            }
        }
    }
    ...
    public void moveDown() {
        for (int i = 0; i < speed; i++) {
            ...
            if (y + OBJECT_SIZE < Attributes.WINDOW_LENGTH && getDirectionLock() != Direction.DOWN) {
                y += 1;
            }
        }
    }
