...
import com.scnu.element.model.DirectionUtil;
import com.scnu.element.model.MyTank;
import com.scnu.element.model.Tank;

import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;
import java.util.ArrayList;

import static com.scnu.element.model.Tank.bulletOut;
 ...
 * @author: Yum
 * @date: 2024/7/8
 * @description: 监听器（使用饿汉单例模式）
 *               使用饿汉单例模式
 *               防止未及时初始化而添加失败
 *               防止重复添加
 */
public class Listener implements KeyListener { //这里接口 优于 继承
