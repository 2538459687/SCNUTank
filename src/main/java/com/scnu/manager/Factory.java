...
import com.scnu.element.map.Buff;
import com.scnu.element.model.EnemyTank;
import com.scnu.element.model.FastEnemyTank;
import com.scnu.element.model.MyTank;
import com.scnu.element.model.StrongEnemyTank;
 ...
 * @author: Yum
 * @date: 2024/7/8
 * @description: 为GameInstance动态创建游戏实体（单例模式），也可归为controller
 */
